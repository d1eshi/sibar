...
const EVAL_SPEC_PATH = "docs/specs/selfhost/pilot/evals/workspace-runner-adapter.eval.json";
const RUST_FIXTURE_PATH = "docs/specs/selfhost/pilot/evals/fixtures/rust_workspace_plan_fixture.json";
