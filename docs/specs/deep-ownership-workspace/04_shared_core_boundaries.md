...
7. `apps/sibar-research-workspace/legacy/vanilla-workspace/scripts/workspace-intent-adapter.js`
...
8. `apps/sibar-research-workspace/legacy/vanilla-workspace/scripts/workspace-intent-adapter.js`
