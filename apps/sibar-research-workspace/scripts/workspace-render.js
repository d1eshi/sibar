...
export function initRootElements(attemptForm, lmContext) {
  return {
    ...
    workspaceIntentBuild: document.getElementById("workspaceIntentBuild"),
    workspaceIntentSource: document.getElementById("workspaceIntentSource"),
    workspaceIntentWhy: document.getElementById("workspaceIntentWhy"),
    workspaceIntentKnown: document.getElementById("workspaceIntentKnown"),
    ...
    workspaceIntentFirstSession: document.getElementById("workspaceIntentFirstSession"),
    workspaceIntentStatus: document.getElementById("workspaceIntentStatus"),
    openWorkspaceSession: document.getElementById("openWorkspaceSession"),
